        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5"
                        style="width:150px"
                        :src="avator" /><span
                        class="font-weight-bold">{{ username }}</span><span class="text-black-50">{{username}}@duke.edu</span><span>
                    </span></div>
            </div>
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Nickname</label><input type="text"
                                class="form-control" placeholder="enter phone number" v-model="nickname"></div>
                    ...
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="button" @click="submit()">Save
                            Profile</button></div>
                </div>
            </div>
            <div class="col-md-4">
